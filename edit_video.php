                            ...
                            <div class="greetings">
                                ...
                                <form action="edit_video.php" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <label for="thumbnailFile" class="form-label mt-3">Upload Thumbnail</label>
                                        <input type="file" class="form-control" id="thumbnailFile" accept="image/*">
                                    </div>
                                    </div>
                                    <button type="submit" class="btn btn-primary">Update Video</button>
                                    <a href="videos.php" class="btn btn-danger">Discard Changes</a> <!-- Added Discard Changes button -->
                                </form>
                                <p></p>
                            </div>
                        </div>
